   ...
   return (
      ...
      >
         ...
         >
            ...
            <div className='flex flex-row items-center py-[4px] px-[10px]
               bg-discount-gradient rounded-[10px] mb-2'
            >
               <img src={discount} alt="discount icon" className='w-[32px]
                     h-[32px] mr-[4px]'
               />
            ...
            <div className='flex flex-row justify-between items-center w-full'>
               ...
               <h1 className='flex-1 font-poppins font-semibold ss:text-[72px]
                  text-[52px] text-white ss:leading-[101px] leading-[75px]'
               >
                  The Next
         ...
         <div className={styles.flexCenter + 'flex-1 flex md:my-0 my-10\
            relative'}
         >
            <img src={robot} alt="robot hand billing" className='relative z-[5]
               w-[100%]'
            />
            ...
            <div className='absolute z-[1] w-[80%] h-[80%] bottom-40 left-40
